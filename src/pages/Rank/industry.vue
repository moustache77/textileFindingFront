      ...
      <!-- <div class="container_main"> -->
          <!-- <div class="el-row" style="height: 770px;margin-left: -10px;margin-right: -10px;box-sizing: border-box;position: relative;"> -->
              <!-- <div class="el-col el-col-21"  style="padding-left: 10px;padding-right: 10px;float: left;box-sizing: border-box;display: block;"> -->
                  <!-- <p class="retrieves_title"></p> -->
                  <!-- <div class="echarts" id="chart"> -->

                  <!-- </div> -->
              <!-- </div> -->
              <div class="el-col el-col-30" style="padding-left: 10px;padding-right: 10px;">
                  <!-- <div class="catalog-main"> -->
                      <p class="theme">行业情报</p>
                      <ul>
                          <li class="photo" >
                                <router-link to='/rank/industry/industry_photo1' exact>
                                <span class="tag"></span>
                                本周纺织行业热门主题
                              </router-link>
                          </li>
                          <li class="photo">
                              <router-link to='/rank/industry/industry_photo2' exact>
                                <span class="tag"></span>
                                优秀企业月度排名
                              </router-link>
                          </li>
                          <li class="photo">
                              <router-link to='/rank/industry/industry_photo3' exact>
                                <span class="tag"></span>
                                行业情绪追踪器
                              </router-link>
                          </li>
                          <li class="photo">
                              <router-link to='/rank/industry/industry_photo4' exact>
                                <span class="tag"></span>
                                行业情绪可视化
                              </router-link>
                          </li>
                          <li class="photo">
                              <router-link to='/rank/industry/industry_photo5' exact>
                                <span class="tag"></span>
                                行业景气指数
                              </router-link>
                          </li>
						  <li class="photo">
                              <router-link to='/rank/industry/industry_photo6' exact>
                                <span class="tag"></span>
                                价格指数
                              </router-link>
                          </li>
